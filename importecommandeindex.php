...
/**
 *	\file       htdocs/importecommande/template/importecommandeindex.php
 *	\ingroup    importecommande
 *	\brief      Home page of importecommande top menu
 */
...
$langs->loadLangs(array("importecommande@importecommande"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->importecommande->read) accessforbidden();
...
llxHeader("",$langs->trans("ImporteCommandeArea"));

print load_fiche_titre($langs->trans("ImporteCommandeArea"),'','title_commercial.png');

print '<div class="fichecenter"><div class="fichethirdleft"><div class="tabBar tabBarWithBottom">';

print '
<form action="upload.php" method="post" enctype="multipart/form-data">
	<table style="width:100%">
		<tr>
			<td>Séléctioner un fichier du type .xlxs</td>
...
// Draft MyObject
if (! empty($conf->importecommande->enabled) && $user->rights->importecommande->read)
{
	$langs->load("orders");
