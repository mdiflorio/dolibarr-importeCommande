...
dol_include_once("/importecommande/class/myobject.class.php");


/**
 * mailing_mailinglist_importecommande
 */
class mailing_mailinglist_importecommande_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_importecommande_myobject';
	...
	var $picto='importecommande@importecommande';
	var $db;
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('importecommande',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/importecommande/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_importecommande_myobject.modules.php: mailing ".$num." targets found");
