...
/**
 * \file    modulebuilder/template/core/boxes/importecommandewidget1.php
 * \ingroup importecommande
 * \brief   Widget provided by ImporteCommande
 *
 ...
 */
class importecommandewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "importecommandebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "importecommande@importecommande";
	 ...
	 */
	public $depends = array('importecommande');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->importecommande->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/importecommande/class/importecommande.class.php";

		// Populate the head at runtime
		$text = $langs->trans("ImporteCommandeBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_importecommande@importecommande',
